...
class Annotator:
    ...
    def get_mean_params(self):
        if not len(self._prev_lines):
            return None

        params = pd.DataFrame(list(self._prev_lines))
        means = {}
    ...
    def detect_lane_lines(self, image):
        ...
        lines, params = hough_lines(masked_image,
        ...
        self._prev_lines.append(params)
